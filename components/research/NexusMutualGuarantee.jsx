  ...
  return (
    <div className="py-6">
      ...
      <div className="grid text-center [&>*]:col-start-1 [&>*]:row-start-1">
        ...
        >
          <span className="inline-flex items-baseline gap-[0.15em] flex-wrap justify-center">
            <Term
              tex={'\\texttt{sellPrice}'}
              label="Sell spot price"
              detail="1e18 × ethReserve / nxmSellReserve"
              align="left"
            />
            <K tex={'\\;\\leq\\;'} />
            <Term
              tex={'\\texttt{bookValue}'}
              label="Book value per NXM"
              detail="1e18 × poolCapital / totalSupply"
            />
            <K tex={'\\;\\leq\\;'} />
            <Term
              tex={'\\texttt{buyPrice}'}
              label="Buy spot price"
              detail="1e18 × ethReserve / nxmBuyReserve"
              align="right"
            />
          </span>
        </div>
      ...
      <div className="text-right mt-4">
        <a
          href="https://github.com/lfglabs-dev/verity-benchmark/blob/main/Benchmark/Cases/NexusMutual/RammPriceBand/Specs.lean"
          target="_blank"
