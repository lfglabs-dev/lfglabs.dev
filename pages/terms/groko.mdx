...
We collect conversations and messages from the Applications to maintain conversation history and provide a functional experience. For more details, please refer to our [Privacy Policy](/privacy/groko).
...
_This EULA applies to the Applications developed by LFG Labs. These Applications are not affiliated with, endorsed by, or sponsored by xAI._
